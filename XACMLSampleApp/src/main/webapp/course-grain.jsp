...
<body bgcolor="#F0F0F0">
	...
	<form name="loanform" method="post" action="controller">
		<br />
		<% if (request.getAttribute("uc1-authorized") != null && (Boolean)request.getAttribute("uc1-authorized")) { %>
		...
		<input type="hidden" name="uc" value="uc1" />
		<table width="450px" align="center">
			<tr>
	...
	<table width="450px" align="center">
		<tr>
			<td style="text-align: center"><a href="course-grain.jsp">Try
					Again</a></td>
		</tr>
		<tr>
