...
<title>Multiple Roles based Authorization</title>
</head>

<body bgcolor="#F0F0F0">
	<h1 align="center">Credit Card Reversal</h1>
	<hr />
	<form name="loanform" method="post" action="controller">
		<br />
		<% if (request.getAttribute("uc3-authorized") != null && (Boolean)request.getAttribute("uc3-authorized")) { %>
		...
		<table width="450px" align="center">
			<tr>
				<td valign="top"><label>Card Number</label></td>
				<td valign="top"><input type="text" name="first_name"
					maxlength="50" size="30"></td>
			</tr>

			<tr>
				<td valign="top"><label>Transaction ID</label></td>
				<td valign="top"><input type="text" name="last_name"
					maxlength="50" size="30"></td>
			</tr>
			<tr>
				<td valign="top"><label>Reversal Amount</label></td>
		...
		<input type="hidden" name="uc" value="uc3" />
		<table width="450px" align="center">
			<tr>
	...
	<table width="450px" align="center">
		<tr>
			<td style="text-align: center"><a href="multi-roles.jsp">Try
					Again</a></td>
		</tr>
		<tr>
